...
namespace Gravity {
    ...
    public:
        using iterator          = std::vector<std::shared_ptr<_TEventListener>>::iterator;
        using const_iterator    = std::vector<std::shared_ptr<_TEventListener>>::const_iterator;
...
namespace Gravity {
    ...
    template<class _TEvent,
             class _TEventListener,
             class _TEventBusId>
    inline EventBus<_TEvent, _TEventListener, _TEventBusId>::iterator 
    ...
    template<class _TEvent,
             class _TEventListener,
             class _TEventBusId>
    inline EventBus<_TEvent, _TEventListener, _TEventBusId>::const_iterator 
