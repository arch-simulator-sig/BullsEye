...
namespace Jasse {
    ...
    //
    impldec_stub2_static(Funct, SPECIAL, DIV,    MIPS32_DIV);
    impldec_stub2_static(Funct, SPECIAL, DIVU,   MIPS32_DIVU);
    impldec_stub2_static(Funct, SPECIAL, MULT,   MIPS32_MULT);
