...
#define _TXT(name)          &Jasse::TextualizeLA32Type##name
    ...
    //
    codedef BEQ         { "beq"         , _T(2RI16    ) , _TR(NORMAL_2ROFFS16       ) , _D_U6L0(  BEQ       ) , _E(BEQ      ) , _TXT(2RI16  ) };
    codedef BNE         { "bne"         , _T(2RI16    ) , _TR(NORMAL_2ROFFS16       ) , _D_U6L0(  BNE       ) , _E(BNE      ) , _TXT(2RI16  ) };
    codedef BLT         { "blt"         , _T(2RI16    ) , _TR(NORMAL_2ROFFS16       ) , _D_U6L0(  BLT       ) , _E(BLT      ) , _TXT(2RI16  ) };
    codedef BGE         { "bge"         , _T(2RI16    ) , _TR(NORMAL_2ROFFS16       ) , _D_U6L0(  BGE       ) , _E(BGE      ) , _TXT(2RI16  ) };
    codedef BLTU        { "bltu"        , _T(2RI16    ) , _TR(NORMAL_2ROFFS16       ) , _D_U6L0(  BLTU      ) , _E(BLTU     ) , _TXT(2RI16  ) };
    codedef BGEU        { "bgeu"        , _T(2RI16    ) , _TR(NORMAL_2ROFFS16       ) , _D_U6L0(  BGEU      ) , _E(BGEU     ) , _TXT(2RI16  ) };

    codedef B           { "b"           , _T(I26      ) , _TR(NORMAL_OFFS26         ) , _D_U6L0(  B         ) , _E(B        ) , _TXT(I26    ) };
    codedef BL          { "bl"          , _T(I26      ) , _TR(NORMAL_OFFS26R1       ) , _D_U6L0(  BL        ) , _E(BL       ) , _TXT(I26    ) };

    codedef JIRL        { "jirl"        , _T(2RI16    ) , _TR(JIRL_2ROFFS16         ) , _D_U6L0(  JIRL      ) , _E(JIRL     ) , _TXT(2RI16  ) };
